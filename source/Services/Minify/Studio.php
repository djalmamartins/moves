...
foreach ([$movesRoot . "/organic/editor/organic-editor.min.css", $themeRoot . "/assets/css/studio-icons.css", $themeRoot . "/assets/css/admin.css", $themeRoot . "/assets/css/studio-system.css"] as $asset) {
