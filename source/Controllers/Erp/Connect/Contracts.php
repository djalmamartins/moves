...
final class Contracts extends Erp
{
    ...
    {
        parent::__construct();
        if ($this->user && !AccessControl::can('erp.contracts.manage', $this->user)) {
            $this->message->warning('Você não possui permissão para gerenciar contratos.')->flash();
