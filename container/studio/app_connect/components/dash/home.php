...
<div class="container main_top">
    <section class="dash">
        <div id="welcome" class="welcome">
            <p class="link--arrowed"><strong>Olá, <?= $user->first_name; ?>!</strong></p>
            <p>Chegou a prestação de contas digital da Connect Condomínios. </p>

            <p>Saiba como navegar pelas contas do condomínio de forma mais rápida e fácil!</p>
            <p>Sempre a procura de como a tecnologia pode melhorar e facilitar a vida em comum.</p>
            <p>
