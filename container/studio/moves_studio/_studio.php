...
<div class="studio-shell">
    <aside class="studio-sidebar">
        <a class="studio-brand-v2" href="<?= url('/studio/dash') ?>">
            <img src="<?= themeStudio('/assets/images/studio-logo.svg', 'moves_studio') ?>" alt="Studio">
    ...
    <main class="studio-main">
        <header class="studio-topbar studio-topbar-v2">
            ...
            <nav class="studio-header-actions" aria-label="Atalhos do painel">
                ...
                <?php $headerPhoto=$user->photo()?image($user->photo(),160,160):themeStudio('/assets/images/avatar.jpg','moves_studio'); $headerRole=$user->accessRole(); ?>
...
<script src="<?= themeStudio('/assets/js/scripts.js', 'moves_studio') ?>"></script>
<script>
