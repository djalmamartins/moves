<div class="dash_content_sidebar">
    <h3 class="icon-asterisk">dashboard/artigos</h3>
    <p class="dash_content_sidebar_desc">Aqui você gerencia todos os artigos e categorias...</p>
    ...
    <nav>
        ...
        echo $nav("pencil-square-o", "blog/home", "Artigos");
