...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        ...
        <a class="icon-plus-circle btn btn-green" href="<?= url("/studio/faq/channel"); ?>">Novo Canal</a>
    </header>
                    ...
                    <?php foreach ($channels as $channel): ?>
                        <article class="radius">
                            <header>
                                ...
                                <div>
                                    <a href="<?= url("/studio/faq/channel/{$channel->id}"); ?>"
                                       class="icon-pencil btn btn-blue">Editar Canal</a>
                                </div>
                                <a href="<?= url("/studio/faq/question/{$channel->id}"); ?>"
                            ...
                            <div>
                                ...
                                $edit = function ($id) use ($channelId) {
                                    $url = url("/studio/faq/question/{$channelId}/{$id}");
