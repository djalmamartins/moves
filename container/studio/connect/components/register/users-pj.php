...
<div class="container">
    ...
    <div class="page_main_header">
        <header>
            ...
            <?php $this->insert("components/register/sidebar"); ?>
        </header>
    </div>
                        ...
                        <div class="main_modal_form">
                            ...
                            <div class="group">
                                ...
                                <label>
                                    ...
                                    <input type="text" name="description" placeholder="Indentifique (Trabalho, Casa e etc...)" value="<?=($profile->address->description ?? ""); ?>" />
                                </label>
                            </div>
                            <div class="group">
                                <label>
