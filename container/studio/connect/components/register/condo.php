...
<div class="container">
    ...
    <div class="page_main">
        <form class="app_form" action="<?= url("erp/register/create"); ?>" method="post">
                            ...
                            <div class="group">
                                ...
                                <label>
                                    ...
                                    <input type="radio" id="radio-one" name="switch-status"
                                           value="registered" checked disabled/>
                            ...
                            <div class="group">
                                <label>
                                    ...
                                    <select name="status">
                                        ...
                                        <option <?= $select("leading"); ?> value="leading" disabled>Endereço</option>
                                    </select>
                                </label>
                                <label></label>
                                <label></label>
