...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        ...
        <form action="<?= url("/operation/events/home"); ?>" method="post" class="app_search_form">
                            ...
                            <header>
                                <div class="actions">
                                    <a class="icon-pencil btn btn-blue" title=""
                                       href="<?= url("/operation/events/post/{$post->id}"); ?>">Editar</a>
                                    <a class="icon-trash btn btn-red" title="" href="#"
                                       data-post="<?= url("/operation/events/post"); ?>"
                                       data-action="delete"
