...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        ...
        <a class="icon-plus-circle btn btn-green" href="<?= url("/operation/events/category"); ?>">Nova Categoria</a>
    </header>
                            ...
                            <div class="info">
                                ...
                                <div class="actions">
                                    <a class="icon-pencil btn btn-blue" title=""
                                       href="<?= url("/operation/events/category/{$category->id}"); ?>">Editar</a>

                                    <a class="icon-trash-o btn btn-red" href="#" title=""
                                       data-post="<?= url("/operation/events/category"); ?>"
                                       data-action="delete"
