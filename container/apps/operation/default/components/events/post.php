...
<div class="mce_upload" style="z-index: 997">
    <div class="mce_upload_box">
        <form class="app_form" action="<?= url("/operation/events/post"); ?>" method="post" enctype="multipart/form-data">
...
<section class="dash_content_app">
    <?php if (!$post): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/operation/events/post"); ?>" method="post">
    ...
    <?php else: ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/operation/events/post/{$post->id}"); ?>" method="post">
