...
<section class="dash_content_app">
    <?php if (!$category): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/operation/results/category"); ?>" method="post">
                <!--ACTION SPOOFING-->
    ...
    <?php else: ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/operation/results/category/{$category->id}"); ?>" method="post">
                <!--ACTION SPOOFING-->
