...
<section class="dash_content_app">
    <?php if (!$club): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/operation/associations/association"); ?>" method="post">
                <!--ACTION SPOOFING-->
    ...
    <?php else: ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/operation/associations/association/{$club->id}"); ?>" method="post">
                <!--ACTION SPOOFING-->
                ...
                <div class="app_form_footer">
                    ...
                    <a href="#" class="remove_link icon-warning"
                       data-post="<?= url("/operation/associations/association/{$club->id}"); ?>"
                       data-action="delete"
