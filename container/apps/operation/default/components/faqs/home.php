...
<section class="dash_content_app">
    <header class="dash_content_app_header">
        ...
        <a class="icon-plus-circle btn btn-green" href="<?= url("/operation/faq/channel"); ?>">Novo Canal</a>
    </header>
                    ...
                    <?php foreach ($channels as $channel): ?>
                        <article class="radius">
                            <header>
                                ...
                                <div>
                                    <a href="<?= url("/operation/faq/channel/{$channel->id}"); ?>"
                            ...
                            <div>
                                ...
                                $edit = function ($id) use ($channelId) {
                                    $url = url("/operation/faq/question/{$channelId}/{$id}");
