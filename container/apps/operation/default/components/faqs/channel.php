...
<section class="dash_content_app">
    <?php if (!$channel): ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/operation/faq/channel"); ?>" method="post">
                <!--ACTION SPOOFING-->
    ...
    <?php else: ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/operation/faq/channel/{$channel->id}"); ?>" method="post">
                <!--ACTION SPOOFING-->
                ...
                <div class="app_form_footer">
                    ...
                    <a href="#" class="remove_link icon-error"
                       data-post="<?= url("/operation/faq/channel/{$channel->id}"); ?>"
                       data-action="delete"
