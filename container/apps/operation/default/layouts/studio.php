...
<div class="studio-shell">
    <aside class="studio-sidebar">
        ...
        <nav class="studio-nav-v2">
            ...
            <?= $nav('tickets','/operation/tickets','Chamados','headset-outline','operation.tickets.manage') ?>
            <small>GESTÃO</small>
